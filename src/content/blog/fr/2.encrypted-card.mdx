...
## Limites connues
La donnée la plus sensible que je veux protéger avec ce projet est mon numéro de téléphone, qui est certainement déjà accessible en ligne publiquement vu le nombre d'appels de prospection que je reçois, je ne cherche donc pas à remplir de véritables objectifs de sécurité.
...
Dans mon cas :
- je tolère que le nonce soit aléatoire dans la mesure où le nombre de chiffrés est très faible, bien en deçà des 6 milliards au-delà desquels le nonce ne serait plus "unique".
