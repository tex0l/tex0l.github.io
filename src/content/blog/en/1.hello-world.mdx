...
I don't think social media are the right tool for me to make this blog: the main goal of this endeavour is not so much to share my opinion, but to form it, whereas social media's main goal is to share it.
...
## How does it work?
I decided to use:
- [Nuxt 3](https://nuxt.com/) in order to be able to build a static website.
