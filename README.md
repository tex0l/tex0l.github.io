...
- **[Vue 3](https://vuejs.org)** — For the interactive bits
- **[Tailwind CSS 4](https://tailwindcss.com)** — Because writing actual CSS is so 2015
- **[TypeScript](https://www.typescriptlang.org)** — Strict mode, obviously
